...
void menuSistema() {
	...
	printf("\t\t    Sistema de Catalogos deportivos\n");
	printf("\t\t    Programacion 2022 | Carlos David Rojas C.\n");
	printf("     ======================================================================\n");
...
void persona::menu()
{
	...
	cout<<"\t\t\t-------------------------------"<<endl;
	cout<<"\t\t\t 1. Ingreso Catalogo"<<endl;
	cout<<"\t\t\t 2. Despliegue Catalogos"<<endl;
	cout<<"\t\t\t 3. Modifica Catalogo"<<endl;
	cout<<"\t\t\t 4. Busca Catalogo"<<endl;
	cout<<"\t\t\t 5. Borra Catalogos"<<endl;
	cout<<"\t\t\t 6. Mostrar Informe"<<endl;
	cout<<"\t\t\t 7. Exit"<<endl;

	cout<<"\t\t\t-------------------------------"<<endl;
	cout<<"\t\t\tOpciones a Selecionar:[1/2/3/4/5/6]"<<endl;
	cout<<"\t\t\t-------------------------------"<<endl;
...
void persona::insert()
{
	...
	fstream file;
	cout<<"\n------------------------------------------------------------------------------------------------------------------------";
	cout<<"\n-------------------------------------------------Agregar detalles Catalogo ---------------------------------------------"<<endl;
	cout<<"\t\t\tIngresa ID Catalogo         : ";
	cin>>id;
	cout<<"\t\t\tIngresa Nombre del catalogo     : ";
	cin>>name;
	cout<<"\t\t\tIngresa Telefono empresarial   : ";
	cin>>phone;
	cout<<"\t\t\tIngresa Epresa del Catalogo: ";
	cin>>college;
...
void persona::display()
{
	...
	fstream file;
	int total=0;
	cout<<"\n-------------------------Tabla de Detalles de los Catalogos -------------------------"<<endl;
	...
	else
	{
		...
		while(!file.eof())
		{
			total++;
			cout<<"\n\n\t\t\t Id Catalogo: "<<id<<endl;
			cout<<"\t\t\t Nombre Catalogo: "<<name<<endl;
			cout<<"\t\t\t Telefono Empresarial: "<<phone<<endl;
			cout<<"\t\t\t Empresa Catalogo: "<<college<<endl;
			cout<<"\t\t\t Direccion Empresa: "<<address<<endl;
			file >> id >> name >> phone >> college >> address;
		}
		if(total==0)
		{
			cout<<"\n\t\t\tNo Exsiste informacion...";
		}
	}
	file.close();
}
void persona::modify()
{
	...
	int found=0;
	cout<<"\n-------------------------Modificacion Detalles del Catalogo-------------------------"<<endl;
	file.open("ParticipantRecord.txt",ios::in);
	if(!file)
	{
	...
	{
		cout<<"\n Ingrese Id del Catalogo que desea modificar: ";
		cin>>participant_id;
		...
		while(!file.eof())
		{
			...
			{
				cout<<"\t\t\tIngrese Id Catalogo: ";
				cin>>id;
				cout<<"\t\t\tIngrese Nombre Catalogo: ";
				cin>>name;
				cout<<"\t\t\tIngrese Telefono Empresarial: ";
				cin>>phone;
				cout<<"\t\t\tIngrese Empresa del Catalogo: ";
				cin>>college;
				cout<<"\t\t\tIngrese Direccion de Empresa: ";
				cin>>address;
				file1<<std::left<<std::setw(15)<< id <<std::left<<std::setw(15)<< name <<std::left<<std::setw(15)<< phone <<std::left<<std::setw(15)<< college <<std::left<<std::setw(15)<< address << "\n";
				found++;
				hora();
...
void persona::search()
{
	...
	if(!file)
	{
		cout<<"\n-------------------------Datos del Catalogo buscado------------------------"<<endl;
		cout<<"\n\t\t\tNo Exsiste esta informacion...";
	}
	else
	{
		string participant_id;
		cout<<"\n-------------------------Datos del catalogo buscado------------------------"<<endl;
		cout<<"\nIngrese Id del Catalogo que quiere buscar: ";
		cin>>participant_id;
		file >> id >> name >> phone >> college >> address;
		while(!file.eof())
		{
			...
			{
				cout<<"\n\n\t\t\t Id Catalogo: "<<id<<endl;
				cout<<"\t\t\t Nombre de Catalogo: "<<name<<endl;
				cout<<"\t\t\t Telefono Empresarial: "<<phone<<endl;
				cout<<"\t\t\t Empresa del  Catalogo "<<college<<endl;
				cout<<"\t\t\t Direccion de Empresa: "<<address<<endl;
				found++;
			}
			file >> id >> name >> phone >> college >> address;
		}
		if(found==0)
		{
			cout<<"\n\t\t\t Catalogo no encontrado en el sistema...";
		}
		file.close();
	}
}
void persona::delet()
{
	...
	string participant_id;
	int found=0;
	cout<<"\n-------------------------Detalles del Catalogo a Borrar-------------------------"<<endl;
	file.open("ParticipantRecord.txt",ios::in);
	if(!file)
	{
		cout<<"\n\t\t\tNo exsiste esta informacion informacion...";
		file.close();
	}
	else
	{
		cout<<"\n Ingrese el Id del catalogo que desea borrar: ";
		cin>>participant_id;
		file1.open("Record.txt",ios::app | ios::out);
		file >> id >> name >> phone >> college >> address;
		while(!file.eof())
